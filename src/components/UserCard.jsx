        ...
        <div className="card bg-[#1E1E2F] w-72 shadow-xl rounded-2xl overflow-hidden transform transition hover:scale-105">
            ...
            <div className="card-body p-4">  
                ...
                <div className="card-actions flex justify-between mt-2">
                    <button className="btn rounded-full px-6 border border-red-500 text-red-400 hover:bg-red-600 hover:text-white transition">
                        Ignore
                    </button>
                    <button className="btn rounded-full px-6 bg-indigo-600 text-white hover:bg-indigo-500 transition">
                        Connect
                    </button>
                </div>
            </div>
