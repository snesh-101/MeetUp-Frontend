...
const Connections = () => {
  ...
  if (!connections)
    return (
      <h1 className="flex justify-center p-5 text-2xl animate-pulse bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent font-bold">
  ...
  if (connections.length === 0)
    return (
      <h1 className="text-center text-xl text-white mt-6 animate-bounce bg-gradient-to-r from-gray-800 to-gray-900 rounded-lg p-6 shadow-2xl">
        No Connections Found
      </h1>
    );
